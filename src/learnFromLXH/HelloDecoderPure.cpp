 ...
 * https://github.com/leixiaohua1020/simplest_ffmpeg_player/blob/master/simplest_ffmpeg_decoder_pure/simplest_ffmpeg_decoder_pure.cpp
...
namespace lxh {
namespace pureDecoder {

int launch() {
  cout << "Hi, pure decoder." << endl;
  ...
  while (1) {
    ...
    while (cur_size > 0) {
      int len = av_parser_parse2(pCodecParserCtx, pCodecCtx, &packet.data, &packet.size, cur_ptr,
